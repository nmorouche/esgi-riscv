...
# deux instructions à écrire pour charger 5 dans t0 et 4 dans t1.
...
# Cas égaux
la a7, msg_eq # msg <- "Ces nombres sont egaux!" 
j end # On a fini donc on peut sortir du if.

# Cas Inégaux
not_eq:
la a7, msg_neq # msg <- "Ces nombres ne sont pas egaux"
###
...
addi a0, a7, 0 # J'ai utilisé addi parce que je n'arrive pas à load a7 dans a0 (avec la)
li a7, 4
ecall
